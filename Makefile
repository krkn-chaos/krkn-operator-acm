...
# krkn-chaos.dev/krkn-operator-acm-bundle:$VERSION and krkn-chaos.dev/krkn-operator-acm-catalog:$VERSION.
IMAGE_TAG_BASE ?= krkn-chaos.dev/krkn-operator-acm
...
KIND_CLUSTER ?= krkn-operator-acm-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name krkn-operator-acm-builder
	$(CONTAINER_TOOL) buildx use krkn-operator-acm-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm krkn-operator-acm-builder
	rm Dockerfile.cross
